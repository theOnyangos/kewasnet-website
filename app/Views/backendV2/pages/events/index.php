            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-green-600 mt-1"><?= number_format($stats['published_events']) ?> published</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-blue-600 mt-1"><?= number_format($stats['total_tickets_sold']) ?> tickets sold</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?= number_format($stats['upcoming_events']) ?></p>
                        <p class="text-sm text-gray-600 mt-1"><?= number_format($stats['paid_events']) ?> paid, <?= number_format($stats['free_events']) ?> free</p>
                    </div>
