...
<?= $this->section('content') ?>
    <main class="flex-1 overflow-y-auto">
        <?= view('backendV2/partials/page_banner', [
            ...
            'pageDescription' => 'Update program information and settings',
            'breadcrumbs' => [
        ...
        <div class="bg-white rounded-b-xl shadow-sm max-w-full program-form-container mx-5">
            <!-- Main Form -->
            <form class="p-6 space-y-6" id="editProgramForm" method="POST" action="<?= site_url('auth/programs/update/' . $program['id']) ?>" enctype="multipart/form-data">
                <?= csrf_field() ?>
                
                <!-- Title Field -->
                <div>
                    <label for="title" class="block text-sm font-medium text-dark mb-1">Program Title <span class="text-red-500">*</span></label>
                    <input type="text" id="title" name="title" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent" placeholder="Enter program title" value="<?= old('title', $program['title']) ?>">
                ...
                <div>
                    ...
                    <div class="flex w-full">
                        ...
                        <input type="text" id="programSlug" name="slug" class="flex-1 min-w-0 px-4 py-3 rounded-none rounded-r-md border border-borderColor focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent" placeholder="url-friendly-slug" value="<?= old('slug', $program['slug']) ?>">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <textarea id="description" name="description" rows="3" maxlength="500" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent resize-none" placeholder="A brief overview of the program"><?= old('description', $program['description']) ?></textarea>
                ...
                <div>
                    ...
                    <div class="rounded-lg">
                        <textarea id="content" name="content" class="summernote-editor w-full px-4 py-3 focus:outline-none" placeholder="Write detailed program content here..."><?= old('content', $program['content']) ?></textarea>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <textarea id="icon_svg" name="icon_svg" rows="4" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent font-mono text-sm" placeholder="<svg>...</svg>"><?= old('icon_svg', $program->icon_svg ?? '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>') ?></textarea>
                        <div class="absolute top-3 left-0 pl-3 flex items-start pointer-events-none">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" id="background_color" name="background_color" class="h-12 w-20 border border-borderColor rounded-lg cursor-pointer" value="<?= old('background_color', $program['background_color'] ?? '#3B82F6') ?>">
                        <input type="text" id="background_color_text" class="flex-1 px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent" placeholder="#3B82F6" value="<?= old('background_color', $program['background_color'] ?? '#3B82F6') ?>">
                    </div>
                    ...
                    <?php if (!empty($program['image_url'])): ?>
                        <div id="current-image" class="mb-4">
                            ...
                            <div class="relative inline-block group">
                                <div class="w-48 h-32 rounded-lg overflow-hidden border-2 border-gray-200 shadow-sm">
                                    <img src="<?= base_url($program['image_url']) ?>" class="w-full h-full object-cover bg-gray-50" alt="Current program image">
                                </div>
                                <button type="button"
                            ...
                            <p class="text-xs text-gray-500 mt-2 italic">Click the X button above to remove this image</p>
                        </div>
                    <?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" id="sort_order" name="sort_order" min="0" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent" placeholder="0" value="<?= old('sort_order', $program['sort_order'] ?? 0) ?>">
                ...
                <div class="pt-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="meta_title" name="meta_title" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent" placeholder="Title for search engines" value="<?= old('meta_title', $program['meta_title'] ?? '') ?>">
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3" maxlength="500" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent resize-none" placeholder="Description for search engines"><?= old('meta_description', $program['meta_description'] ?? '') ?></textarea>
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_keywords" name="meta_keywords" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent" placeholder="Comma-separated keywords" value="<?= old('meta_keywords', $program['meta_keywords'] ?? '') ?>">
                ...
                <div class="pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col space-y-3">
                                <label class="inline-flex items-center p-3 border border-borderColor rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-secondary has-[:checked]:bg-secondaryShades-100">
                                    <input type="radio" name="is_active" value="1" <?= old('is_active', $program['is_active']) == '1' ? 'checked' : '' ?> class="h-4 w-4 text-secondary focus:ring-secondary border-borderColor">
                                    <div class="ml-3">
                                ...
                                <label class="inline-flex items-center p-3 border border-borderColor rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-secondary has-[:checked]:bg-secondaryShades-100">
                                    <input type="radio" name="is_active" value="0" <?= old('is_active', $program['is_active']) == '0' ? 'checked' : '' ?> class="h-4 w-4 text-secondary focus:ring-secondary border-borderColor">
                                    <div class="ml-3">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col space-y-3">
                                <label class="inline-flex items-center p-3 border border-borderColor rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-secondary has-[:checked]:bg-secondaryShades-100">
                                    <input type="checkbox" name="is_featured" value="1" <?= old('is_featured', $program['is_featured']) ? 'checked' : '' ?> class="h-4 w-4 text-secondary focus:ring-secondary border-borderColor rounded">
                                    <div class="ml-3">
...
<?= $this->section('scripts'); ?>
    <script>
        ...
        function removeCurrentImage() {
            Swal.fire({
                title: 'Remove Image?',
                text: 'Are you sure you want to remove the current program image?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(() => {
                        Swal.fire({
                            title: 'Removed!',
                            text: 'Image will be removed when you update the program.',
                            icon: 'success',
                            timer: 2000,
