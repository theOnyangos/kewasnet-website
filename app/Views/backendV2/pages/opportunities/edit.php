...
<?= $this->section('content') ?>
    <main class="flex-1 overflow-y-auto">
        <?= view('backendV2/partials/page_banner', [
            ...
            'pageDescription' => 'Update the details of the opportunity below',
            'breadcrumbs' => [
        ...
        <div class="px-6 pb-6">
            <div class="bg-white rounded-b-xl shadow-sm max-w-full pillar-form-container">
                ...
                <form id="jobForm" class="space-y-6 p-6" action="<?= site_url('auth/opportunities/update/' . $opportunity['id']) ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <!-- CSRF Token -->
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" placeholder="Enter job title" value="<?= esc($opportunity['title'] ?? '') ?>"
                            ...
                            <div>
                                ...
                                <select id="opportunity_type" name="opportunity_type" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary select2">
                                    ...
                                    <option value="full-time" <?= ($opportunity['opportunity_type'] ?? '') === 'full-time' ? 'selected="selected"' : '' ?>>Full-time</option>
                                    <option value="part-time" <?= ($opportunity['opportunity_type'] ?? '') === 'part-time' ? 'selected="selected"' : '' ?>>Part-time</option>
                                    <option value="contract" <?= ($opportunity['opportunity_type'] ?? '') === 'contract' ? 'selected="selected"' : '' ?>>Contract</option>
                                    <option value="internship" <?= ($opportunity['opportunity_type'] ?? '') === 'internship' ? 'selected="selected"' : '' ?>>Internship</option>
                                    <option value="freelance" <?= ($opportunity['opportunity_type'] ?? '') === 'freelance' ? 'selected="selected"' : '' ?>>Freelance</option>
                                </select>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="company" name="company" placeholder="Enter company/organization name" value="<?= esc($opportunity['company'] ?? '') ?>"
                                    class="mt-1 block w-full rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent sm:text-sm p-3 border">
                            ...
                            <div>
                                ...
                                <input id="datepicker" name="application_deadline" value="<?= isset($opportunity['application_deadline']) ? date('Y-m-d', strtotime($opportunity['application_deadline'])) : '' ?>" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" rows="4" placeholder="Enter job description"
                                class="mt-1 block w-full rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent sm:text-sm p-3 border"><?= esc($opportunity['description'] ?? '') ?></textarea>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="rounded-lg">
                                <textarea id="scope" name="scope" class="summernote-editor w-full px-4 py-3 focus:outline-none" placeholder="Enter detailed job scope and responsibilities..."><?= esc($opportunity['scope'] ?? '') ?></textarea>
                            </div>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="location" name="location" placeholder="Enter job location" value="<?= esc($opportunity['location'] ?? '') ?>"
                                    class="mt-1 block w-full rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent sm:text-sm p-3 border">
                            </div>
                            ...
                            <div class="flex items-center mt-6">
                                ...
                                <input id="is_remote" name="is_remote" type="checkbox" value="1" <?= !empty($opportunity['is_remote']) && $opportunity['is_remote'] == 1 ? 'checked="checked"' : '' ?>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md">
                                    ...
                                    <input type="number" id="salary_min" name="salary_min" min="0" step="0.01" placeholder="Enter minimum salary" value="<?= esc($opportunity['salary_min'] ?? '') ?>"
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md">
                                    ...
                                    <input type="number" id="salary_max" name="salary_max" min="0" step="0.01" placeholder="Enter maximum salary" value="<?= esc($opportunity['salary_max'] ?? '') ?>"
                                        class="block w-full pl-12 pr-12 rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent sm:text-sm p-3 border">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="salary_currency" name="salary_currency" class="w-full px-4 py-3 border border-borderColor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary select2">
                                    <option value="USD" <?= ($opportunity['salary_currency'] ?? '') === 'USD' ? 'selected="selected"' : '' ?>>USD</option>
                                    <option value="EUR" <?= ($opportunity['salary_currency'] ?? '') === 'EUR' ? 'selected="selected"' : '' ?>>EUR</option>
                                    <option value="GBP" <?= ($opportunity['salary_currency'] ?? '') === 'GBP' ? 'selected="selected"' : '' ?>>GBP</option>
                                    <option value="KES" <?= ($opportunity['salary_currency'] ?? 'KES') === 'KES' ? 'selected="selected"' : '' ?>>KES</option>
                    ...
                    <div class="border-b border-gray-200 pb-6" id="typeSpecificFields">
                        ...
                        <div class="mt-6 <?= ($opportunity['opportunity_type'] ?? '') === 'contract' ? '' : 'hidden' ?>" id="contractFields">
                            <label for="contract_duration" class="block text-sm font-medium text-gray-700">Contract Duration</label>
                            <input type="text" id="contract_duration" name="contract_duration" value="<?= esc($opportunity['contract_duration'] ?? '') ?>"
                                class="mt-1 block w-full rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent sm:text-sm p-3 border"
                                placeholder="e.g., 6 months">
                        </div>
                        
                        <!-- Hours Per Week (shown for part-time type) -->
                        <div class="mt-6 <?= ($opportunity['opportunity_type'] ?? '') === 'part-time' ? '' : 'hidden' ?>" id="hoursFields">
                            <label for="hours_per_week" class="block text-sm font-medium text-gray-700">Hours Per Week</label>
                            <input type="number" id="hours_per_week" name="hours_per_week" min="1" max="40" placeholder="Enter hours per week" value="<?= esc($opportunity['hours_per_week'] ?? '') ?>"
                                class="mt-1 block w-full rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent sm:text-sm p-3 border">
                        </div>
                            ...
                            <div class="mt-2 space-y-2" id="benefitsContainer">
                                <?php 
                                    ...
                                    if (!empty($opportunity['benefits'])) {
                                        $benefits = is_string($opportunity['benefits']) ? json_decode($opportunity['benefits'], true) : $opportunity['benefits'];
                                ...
                                <div class="flex items-center">
                                    <input type="text" name="benefits[]" value="<?= esc($benefit) ?>"
                                    ...
                                    <button type="button" class="ml-2 text-red-500 remove-benefit <?= count($benefits) <= 1 ? 'hidden' : '' ?>">
                            ...
                            <div class="mt-2 space-y-2" id="requirementsContainer">
                                <?php 
                                    ...
                                    if (!empty($opportunity['requirements'])) {
                                        $requirements = is_string($opportunity['requirements']) ? json_decode($opportunity['requirements'], true) : $opportunity['requirements'];
                                ...
                                ?>
                                <div class="flex items-center">
                                    <input type="text" name="requirements[]" value="<?= esc($requirement) ?>"
                                        class="block w-full rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent sm:text-sm p-3 border"
                                        placeholder="e.g., 3+ years experience">
                                    <button type="button" class="ml-2 text-red-500 remove-requirement <?= count($requirements) <= 1 ? 'hidden' : '' ?>">
                                        <i class="fas fa-times"></i>
                                    </button>
                                </div>
                                <?php endforeach; ?>
                    ...
                    <div class="">
                        ...
                        <?php if (!empty($opportunity['document'])): ?>
                        <div class="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <i data-lucide="file-text" class="text-blue-600 w-6 h-6 mr-2"></i>
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">Current Document:</p>
                                        <p class="text-sm text-gray-600"><?= esc(basename($opportunity['document'])) ?></p>
                                    </div>
                                </div>
                                <a href="<?= base_url($opportunity['document']) ?>" target="_blank" class="text-blue-600 hover:text-blue-800">
                                    <i data-lucide="download" class="w-5 h-5"></i>
                                </a>
                            </div>
                        </div>
                        <p class="text-sm text-gray-600 mb-2">Upload a new document to replace the existing one</p>
                        <?php endif; ?>
                            ...
                            <div class="">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <label class="inline-flex items-center p-3 border border-borderColor rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-secondary has-[:checked]:bg-secondaryShades-100">
                                        <input type="radio" name="status" value="draft" <?= ($opportunity['status'] ?? '') === 'draft' ? 'checked="checked"' : '' ?> class="h-4 w-4 text-secondary focus:ring-secondary border-borderColor">
                                        <div class="ml-3">
                                    ...
                                    <label class="inline-flex items-center p-3 border border-borderColor rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-secondary has-[:checked]:bg-secondaryShades-100">
                                        <input type="radio" name="status" value="published" <?= ($opportunity['status'] ?? '') === 'published' ? 'checked="checked"' : '' ?> class="h-4 w-4 text-secondary focus:ring-secondary border-borderColor">
                                        <div class="ml-3">
                                    ...
                                    <label class="inline-flex items-center p-3 border border-borderColor rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-secondary has-[:checked]:bg-secondaryShades-100">
                                        <input type="radio" name="status" value="closed" <?= ($opportunity['status'] ?? '') === 'closed' ? 'checked="checked"' : '' ?> class="h-4 w-4 text-secondary focus:ring-secondary border-borderColor">
                                        <div class="ml-3">
                ...
                <div class="flex items-center justify-center min-h-full">
                    <div class="bg-white rounded-lg p-6 w-96 max-w-full mx-4">
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-medium text-gray-900 mb-2">Updating Job Opportunity</h3>
                            <p class="text-sm text-gray-500 mb-4" id="progressText">Please wait while we update your job opportunity...</p>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('jobForm').addEventListener('submit', function(e) {
                ...
                // Submit via AJAX
                fetch('<?= site_url('auth/opportunities/update/' . $opportunity['id']) ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
                    ...
                    setTimeout(() => {
                        ...
                        if (data.status === 'success' || data.data) {
                            ...
                            if (typeof showNotification === 'function') {
                                showNotification('success', 'Job opportunity updated successfully!');
                            } else {
                                showSuccessMessage('Job opportunity updated successfully!');
                            }
                            ...
                            if (typeof showNotification === 'function') {
                                showNotification('error', data.message || 'Failed to update job opportunity. Please try again.');
                            } else {
                                showErrorMessage(data.message || 'Failed to update job opportunity. Please try again.');
                            }
                        }
                    }, 500);
                })
                .catch(error => {
                    ...
                    if (error.errors) {
                        ...
                        if (typeof showNotification === 'function') {
                            showNotification('error', error.message || 'An error occurred while updating the job opportunity. Please try again.');
                        } else {
                            showErrorMessage(error.message || 'An error occurred while updating the job opportunity. Please try again.');
                        }
                    }
                });
            });
