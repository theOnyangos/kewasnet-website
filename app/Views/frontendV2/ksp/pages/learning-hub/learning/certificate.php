...
if (!$user || !$course) {
    ...
    echo '<div class="cert-error">Invalid certificate request.</div>';
    return;
}
?>
<!DOCTYPE html>
        ...
        <div class="cert-wrapper">
            <div class="cert-inner">
                    ...
                    <div class="certificate-content">
                        ...
                        <div class="logo-wrapper">
                            <div class="logo-container">
                                <img src="<?= base_url('assets/new/site-logo-transparent.png') ?>" alt="KEWASNET Logo" class="logo-img">
                            </div>
                        </div>
                        ...
                        <div class="main-content">
                            ...
                            <div class="name-box">
                                <div class="name-text">
                                    <?= esc(ucwords($user['first_name'] . ' ' . $user['last_name'])) ?>
                                </div>
                            </div>
                        ...
                        <div class="cert-footer">
                            <div class="footer-grid">
                                ...
                                <div class="footer-item footer-item-left">
                                    ...
                                    <div class="cert-number"><?= esc($certificateId) ?></div>
                                </div>
                        ...
                        <div class="decorative-seal">
                            <div class="seal-circle">
                                <i data-lucide="award" class="seal-icon"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="download-section">
                    <a href="<?= base_url('ksp/learning-hub/certificate/' . $course['id'] . '/download') ?>" class="download-btn">
