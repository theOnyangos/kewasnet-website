...
<?= $this->section('content') ?>
    ...
    <main class="py-12 relative">
        ...
        <section class="container mx-auto px-4 mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                <!-- WASH -->
                <a href="<?= base_url('ksp/learning-hub?category=1') ?>" class="pillar-category bg-white rounded-lg overflow-hidden shadow-md border borderColor hover:shadow-2xl transition-shadow">
                ...
                <!-- Climate Change -->
                <a href="<?= base_url('ksp/learning-hub?category=2') ?>" class="pillar-category bg-white rounded-lg overflow-hidden shadow-md border borderColor hover:shadow-2xl transition-shadow">
                    <div class="p-6 text-center">
                        <div class="bg-secondaryShades-100 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                ...
                <!-- Governance -->
                <a href="<?= base_url('ksp/learning-hub?category=3') ?>" class="pillar-category bg-white rounded-lg overflow-hidden shadow-md border borderColor hover:shadow-2xl transition-shadow">
                    <div class="p-6 text-center">
                        <div class="bg-secondaryShades-100 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                ...
                <!-- NEXUS -->
                <a href="<?= base_url('ksp/learning-hub?category=4') ?>" class="pillar-category bg-white rounded-lg overflow-hidden shadow-md border borderColor hover:shadow-2xl transition-shadow">
                    <div class="p-6 text-center">
                        <div class="bg-secondaryShades-100 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                ...
                <!-- IWRM -->
                <a href="<?= base_url('ksp/learning-hub?category=5') ?>" class="pillar-category bg-white rounded-lg overflow-hidden shadow-md border borderColor hover:shadow-2xl transition-shadow">
                    <div class="p-6 text-center">
                        <div class="bg-secondaryShades-100 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
        ...
        <section class="container mx-auto px-4 mb-16">
            <!-- Filters and Search -->
            <div class="bg-white rounded-lg border border-slate-200 p-6 mb-8 shadow-md hover:shadow-2xl transition-shadow">
        ...
        <?php if (!empty($testimonials)): ?>
            <section class="container mx-auto px-4 mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    ?>
                    <div class="bg-white p-6 rounded-lg border borderColor shadow-md hover:shadow-2xl transition-shadow">
    ...
    <!-- Call to Action -->
    <section class="bg-gradient-to-r from-primary shadow-md to-secondary overflow-hidden p-8 md:p-12 text-white">
