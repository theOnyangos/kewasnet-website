...
<meta name="description" content="<?= $this->renderSection("description") ?? ($description ?? "KEWASNET - Kenya Water and Sanitation Civil Society Network. Discover events, workshops, and conferences in Kenya's WASH sector.") ?>">
...
<meta property="og:description" content="<?= $this->renderSection("description") ?? ($description ?? "KEWASNET - Kenya Water and Sanitation Civil Society Network. Discover events, workshops, and conferences in Kenya's WASH sector.") ?>">
...
<meta name="twitter:description" content="<?= $this->renderSection("description") ?? ($description ?? "KEWASNET - Kenya Water and Sanitation Civil Society Network. Discover events, workshops, and conferences in Kenya's WASH sector.") ?>">
