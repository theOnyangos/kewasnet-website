...
function pieChart(e, t, o, r = "270") {
  var a = {
    ...
    colors: ["#349331", "#8231D3", "#00AAFF", "#f5963b"],
...
function radialChart(e, t, o, r = "270") {
  var a = {
    series: t,
    colors: ["#01b81a", "#8231D3", "#00AAFF", "#FA8B0C"],
    chart: {
      width: o,
      height: r,
      type: "radialBar",
    ...
    labels: ["Ksh 100", "ksh 200", "Ksh 500", "Ksh 1000"],
  };
  $(e).length > 0 && new ApexCharts(document.querySelector(e), a).render();
}
...
// storage(".storage", [50], 271),
storage(".storage2", [90], 310),
  // pieChart(".apexPieToday", [20, 20, 50, 60], "100%", 270),
  DonutChart(
    ".salesDonutToday",
    [30, 30, 40],
    "100%",
  ...
  // radialChart(".performanceDetails", [90, 60, 80, 10], "100%", 280),
    ...
    new Chart(d, {
      ...
      data: {
        ...
        datasets: [
          {
            data: a,
            backgroundColor: "rgba(86, 255, 64, .50)",
            hoverBackgroundColor: "#56ff40",
            label: n,
            barPercentage: 0.45,
            borderRadius: 2,
...
!(function (e) {
  ...
  p.classList.add("overlay-dark"),
    ...
    e(
      "#countryOption,#cityOption,#skillsOption,#exampleFormControlSelect1,#select-countryOption,.universal-select"
    ).select2({
